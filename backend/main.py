...
topics = {
    'Science': [
        ...
        {'question': 'State the 4 main constituents of blood (Separate each constituent with a comma)', 'type': 'Open-Ended', 'correct_answer': 'Red blood cell, White blood cell, Plasma, Platelets'},
        ...
        {'question': 'Define the Principle of Moments', 'type': 'Open-Ended', 'correct_answer': 'The Principle of Moments states that when a body is in equilibrium, the sum of clockwise moments about a pivot is equal to the sum of anticlockwise moments about the same pivot.'},
    ],
    ...
    "Ngee Ann": [
        ...
        {'question': 'What is the name of the NPs library?', 'type': 'Open-Ended', 'correct_answer': 'Lien Ying Chow'},
        ...
        {'question': 'Which local artiste recently enrolled in NP as a student? (Full name)', 'type': 'Open-Ended', 'correct_answer': 'Dennis Chew'},
    ...
    "IT": [
        ...
        {'question': 'Which Python function tells me the length of a string? (Include the parenthesis)', 'type': 'Open-Ended', 'correct_answer': 'len()'},
        ...
        {'question': 'The first web browser invented in 1990 was?', 'type': 'Open-Ended', 'correct_answer': 'World Wide Web'},
    ...
    "Math": [
        ...
        {'question': 'Solve (3x-4) / 2 - 2x/3 = 1. Express your answer in decimals', 'type': 'Open-Ended', 'correct_answer': '3.6'},
        {'question': 'Whose theorem states that a^2 + b^2 = c^2', 'type': 'Open-Ended', 'correct_answer': 'Pythagoras'},
        {'question': 'Find the prime factors of 1188, giving your answer in index form (use ^ for to the power of, and * for multiplication, NO SPACING)', 'type': 'Open-Ended', 'correct_answer': '2^2*3^3*11'},
    ],
}
